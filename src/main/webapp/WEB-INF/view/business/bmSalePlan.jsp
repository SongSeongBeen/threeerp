...
<script type="text/javascript">
   ...
   $("#plall").change( function() {			
	...
	$("#pmall").change( function() {			
		productCombo("p", "divproducttall", "all", $("#pmall").val(),"");    // 제품 중분류
	});			
							...
							<tbody id="listBmSalePlan">
							 <tr style="border: 10px; border-color: blue">
						                        ...
						                        <tr style="border: 10px; border-color: blue">
						                           ...
						                           <td colspan=5>productCombo("m", "pmall", "all", $("#plall").val(),"");   <br> 구분("m"  : 대분류)     , Combo Name, Option("all" : 전체     "sel" : 선택 , 대분류 코드</td>      
						                        </tr>				
						                        
						                        <tr style="border: 10px; border-color: blue">
						                           <td width="40" height="25" style="font-size: 100%">제품명</td>
						                           <td colspan=5>productCombo("p", "divproducttall", "all", $("#pmall").val(),"");   <br> 구분("p"  : 제품정보)     , Combo Name, Option("all" : 전체     "sel" : 선택 , 중분류 코드</td>      
						                        </tr>	
